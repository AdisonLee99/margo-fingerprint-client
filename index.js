...
(async function () {
  ...
  const MY_GET_FP = new Proxy({
              ...
              if (prop == "init") {
                  ...
                  if (this._blockInit) return null;
                  this._blockInit = true;
  ...
  const accountId = iface === "ni" ? Engine.hero.d.account : hero.id;
    ...
    waitFor(() => typeof MY_GET_FP !== "undefined" && typeof MY_GET_FP.fp !== "undefined")
      .then(() => {
        const savedPosition = JSON.parse(localStorage.getItem("fp_widget_position")) || { top: 27, left: window.innerWidth / 2 };
  ...
  width: "min-width",
        ...
        document.addEventListener("mousemove", (e) => {
          ...
          localStorage.setItem("fp_widget_position", JSON.stringify({ top: y, left: x }));
        });
        ...
        let isMinimized = JSON.parse(localStorage.getItem("fp_widget_minimized") || "false");
